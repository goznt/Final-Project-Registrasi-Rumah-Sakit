  ...
  case 2:
   ...
   cout<<" ___________________________________________________________"<<endl;
       ...
       cout<<" Pelayanan Spesialis Penyakit Dalam"<<endl<<endl;
                cout<<" |#############|    Prof.dr.Pande Putu Diah Maharani,Sp.PD-KPTI"<<endl;
                cout<<" |             |    Spesialis:"<<endl;
        ...
        cout<<" | Biaya Dokter                  || Rp 3300000,-                 *per 1x perawatan"<<endl;
            ...
            else if (rawat == '3')
            {
             system("cls");
                ...
                cout<<" |#############|    dr. Julia Rifaldo,Sp.THT-KL"<<endl;
                cout<<" |             |    Spesialis:"<<endl;
        ...
        cout<<" | Biaya Dokter                      || Rp 2700000,-                 *per 1x perawatan"<<endl;
            ...
            else if (rawat == '4')
            {
             system("cls");
                ...
                cout<<" |#############|    dr.Agus Sudarsono, SpB"<<endl;
                cout<<" |             |    Spesialis:"<<endl;
